...
<template>
  <div class="info">
    ...
    <ul>
      ...
      <li>
        Here, we assume that the camera lens is singe symmetric spherical convex lens. The real camera lens is
        composed
        from multiple types of lenses.
      </li>
      <li>
        The rays inside the ideal lens are not visualized correctly. The rays are refracted at the center plane
        of
        the
        lens.
      </li>
